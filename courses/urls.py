...
urlpatterns = patterns('',
    url(r'^(?P<pk>\d+)/add_lesson/$', views.LessonCreateView.as_view(), name='add-lesson'),#include(patterns('courses.views',url(r'^add_lesson$', views.add_lesson, name = 'add-lesson'),)),
